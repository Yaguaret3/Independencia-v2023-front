...
const ChiquitosSubregion = () => {
    ...
    return (
        <Tooltip title="Chiquitos">
            <g id="Chiquitos">
                <path style={{ fill: color, opacity: opacity }}
                    d="M733.42,209.22c-1.09,7.69-3.15,14.64,2,22.31c2.86,4.25,1.88,11.17,2.28,16.9c0.07,0.98-1.76,2-2.49,3.14
...
export default ChiquitosSubregion